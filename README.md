...
| **Rakshana** | **Data Scientist & EDA Lead** | • Comprehensive **Data Preprocessing & Cleaning Pipelines** for Olist & UCI datasets<br>• In-depth **Exploratory Data Analysis (EDA)**, statistical distributions, & correlation heatmaps<br>• Feature engineering logs, schema mappings (`SCHEMA_MAPPING.md`), & Tableau exports |
| **Kommisetti Harshitha** | **Data Analyst & ML Specialist** | • **Sales Trend & Demand Forecasting Analysis** (`notebooks/predict_sales.ipynb`)<br>• Monthly sales aggregations, forecast validation, & trend chart generation (`output/sales_forecast.png`)<br>• Data modeling evaluation and exploratory time-series research |
...
| **Bhargavi Kurapati** | **System Analyst & Documentation** | • Business attribute requirements analysis & workflow diagrams<br>• UI wireframing specifications & dataset structure evaluation |
